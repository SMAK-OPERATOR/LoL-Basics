...
import adcData from '../../../../../data/json/jungle.json'
import Image from 'next/image';
import {ProgressTimeline} from '@/components/guides/ProgressTimelineJungle';
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.lastBlock}>
                        <div className={styles.leftBlock}>
                            ...
                            <CustomButton href={"/guides/jungle/1/test"} theme="jungle">
                                Начать тест
                            </CustomButton>
                        </div>
                        <div className={styles.rightBlock}>
                            <p className={styles.buttonText}>Следующий раздел</p>
                            <CustomButton href={"/guides/jungle/2"} theme="jungle">
                                Перейти
                            </CustomButton>
                        </div>
                    </div>

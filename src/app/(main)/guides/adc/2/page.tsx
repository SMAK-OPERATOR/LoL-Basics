                ...
                <header className={styles.header}>
                    ...
                    >
                        ...
                        <div
                            ...
                            ref={dropdownMenuRef}
                        >
                            <Link href="/guides/all" className={styles.dropdownItem}>Вводный курс</Link>
                            <Link href="/guides/top" className={styles.dropdownItem}>Верхняя линия</Link>
                            <Link href="/guides/jungle" className={styles.dropdownItem}>Лес</Link>
                            <Link href="/guides/mid" className={styles.dropdownItem}>Средняя линия</Link>
                            <Link href="/guides/adc" className={styles.dropdownItem}>Стрелок</Link>
                            <Link href="/guides/support" className={styles.dropdownItem}>Поддержка</Link>
                        </div>
                    </div>
                    <div className={styles.divider}></div>
                    <nav>
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.lastBlock}>
                        <div className={styles.leftBlock}>
                            ...
                            <CustomButton href={"/guides/adc/2/test"} theme="adc">
                                Начать тест
                            </CustomButton>
                        </div>
                        <div className={styles.rightBlock}>
                            <p className={styles.buttonText}>Следующий раздел</p>
                            <CustomButton href={"/guides/adc/3"} theme="adc">
                                Перейти
                            </CustomButton>
                        </div>
                    </div>

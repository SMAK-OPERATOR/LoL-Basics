...
import adcData from '../../../../../data/json/support.json'
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.lastBlock}>
                        <div className={styles.leftBlock}>
                            ...
                            <CustomButton href={"/guides/support/1/test"} theme="support">
                                Начать тест
                            </CustomButton>
                        </div>
                        <div className={styles.rightBlock}>
                            <p className={styles.buttonText}>Следующий раздел</p>
                            <CustomButton href={"/guides/support/2"} theme="support">
                                Перейти
                            </CustomButton>
                        </div>
                    </div>
